$(document).ready(function(){
	...
	function variabel(){
		...
		dataString='branch='+branch+'&bln='+bln+'&thn='+thn+'&produk='+produk+'&kdsales='+kdsales+'&tgl1='+tgl1+'&tgl2='+tgl2+'&kkbayar='+kkbayar+'&flag='+flag+'&kdbyr='+kdbyr+'&kdkop='+kdkop;
	}
});
$(function() {
	$("#btnpdf").button({
