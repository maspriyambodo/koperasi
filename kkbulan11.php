...
<div id="tabs">
	<ul>
		...
		<li><a href="kkbulan12.php">SUDAH REALISASI</a></li>
		<li><a href="#tabs-3">TIDAK TERTAGIH</a></li>
		<li><a href="kkbulan13.php">REKAP TAGIHAN</a></li>
	</ul>
	<div id="tabs-1" style="width: 96%;height:440px;overflow: auto;">';
		if($kkbayar!=9){
			$hasil=$result->query_lap("SELECT a.id,a.norek,a.nama,b.nocitra,b.nopen,a.pokok,a.bunga,a.adm,a.angsurke,a.jumlah,a.kdtran,a.alasan_tt,a.solusi_tt,b.kkbayar FROM $tabelTagihan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE b.kkbayar='$kkbayar' AND a.branch='$kcabang' AND a.kdtran=111 ORDER BY kdtran,nama,nocitra,norek");
		}else{
			$hasil=$result->query_lap("SELECT a.id,a.norek,a.nama,b.nocitra,b.nopen,a.pokok,a.bunga,a.adm,a.angsurke,a.jumlah,a.kdtran,a.alasan_tt,a.solusi_tt,b.kkbayar FROM $tabelTagihan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE a.branch='$kcabang' AND a.kdtran=111 ORDER BY a.nama,b.nocitra,a.norek");	
		}
		echo '
	...
	<div id="tabs-3" style="width: 96%;height:440px;overflow: auto;">';
		if($kkbayar!=9){
			...
			$hasil=$result->query_lap("SELECT a.id,a.norek,a.nama,b.nocitra,b.nopen,a.pokok,a.bunga,a.adm,a.angsurke,a.jumlah,a.kdtran,a.alasan_tt,a.solusi_tt,b.kkbayar FROM $tabelTagihan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE a.branch='$kcabang' AND a.kdtran=333 ORDER BY a.nama,b.nocitra,a.norek");	
		}
		echo '
