...
<?php
$no=1;
$tnomi=0;$tsaldo=0;$tlunas=0;$tbungakk=0;$tjumbtl=0;$tjumadm=0;$tjumprovisi=0;$tmeterai=0;$tjumpremi=0;$tpotongan=0;$tterima=0;$vbayar='9';$tjumangsur=0;$jnomi=0;$jsaldo=0;$jlunas=0;$jbungakk=0;$jjumbtl=0;$jjumadm=0;$jjumprovisi=0;$jmeterai=0;$jjumpremi=0;$jpotongan=0;$jterima=0;$jjumangsur=0;$jumangsur=0;
while ($row=$result->row($hasil)){
	...
	if ($vbayar<>$row['produk']){
		...
		<tr>
		<td colspan="17"><strong><?php echo $row['nmproduk'];?></strong></td>
		</tr> <?php
