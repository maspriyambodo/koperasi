...
<tbody>
<?php
$no=1;$vnmbayar='';$vbayar='9';$tnomi=0;$tsaldo=0;$tlunas=0;$tbungakk=0;$tjumbtl=0;$tjumadm=0;$tjumprovisi=0;$tmeterai=0;$tjumpremi=0;$tpotongan=0;$tterima=0;$tjumangsur=0;$jnomi=0;$jsaldo=0;$jlunas=0;$jbungakk=0;$jjumbtl=0;$jjumadm=0;$jjumprovisi=0;$jmeterai=0;$jjumpremi=0;$jpotongan=0;$jterima=0;$jjumangsur=0;$jumangsur=0;$torang=0;$jorang=0;
while ($row=$result->row($hasil)){
	...
	if ($vbayar<>$row['kkbayar']){
		...
		<tr><td colspan="16"><strong>KANTOR BAYAR : <?php echo $row['nmbayar'];?></strong></td></tr><?php $tnomi=0;$tsaldo=0;$tlunas=0;$tbungakk=0;$tjumbtl=0;$tjumadm=0;$tjumprovisi=0;$tmeterai=0;$tjumpremi=0;$tpotongan=0;$tterima=0;$tjumangsur=0;$torang=0;
	}?>
	<tr>
		<td><?php echo $no; ?></td>
