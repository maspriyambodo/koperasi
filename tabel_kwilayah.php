...
<script TYPE="text/javascript">
	url1="tabel_kwilayah01.php";
	url2="tabel_kwilayah02.php?p=1";
	url3="tabel_kwilayah02.php?p=2";
	url4="tabel_kwilayah.php";
	uhead='DATA TABEL WILAYAH KERJA';
	lebar=550;
	tinggi=300;
</script>
<?php 
$hasil=$result->query_x1("SELECT id,branch,kd,nmkb FROM $tabel_wkb ORDER BY kd");$no=1;
?>
<button id="tambah">Tambah Wilayah Kerja</button>
