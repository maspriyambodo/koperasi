...
<tr><td colspan="4" align="center" class="ui-state-highlight"><strong>DATA KREDIT DEBITUR</strong></td></tr>
<tr>
...
<tr>
	<td>No Dapem/Karip</td><td>: '.$row['nodapem'].' / '.$row['nokarip'].'</td>
...
<tr>
	<td>Norek Simpanan Pokok</td><td>: '.$row['norekp'].'</td>
	<td>Norek Simpanan Wajib</td><td>: '.$row['norekw'].'</td>
</tr>
<tr><td colspan="4" align="center" class="ui-state-highlight"><strong>DATA FINANSIAL DEBITUR</strong></td></tr>
<tr>
...
<tr><td colspan="4" align="center" class="ui-state-highlight"><strong>JAMINAN KREDIT DEBITUR : '.$xkdskep.'</strong></td></tr>';
if($kdskep==0){
	echo '<tr>
