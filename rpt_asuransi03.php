...
<script type="text/javascript">
	var url1="asuransi/asuransi02.php?p=1";
	var url2="asuransi/asuransi02.php?p=2";
	var url3="asuransi/asuransi02.php?p=3";
	var url4="asuransi/asuransi03.php?p=1";
	var url5="asuransi/asuransi03.php?p=2";
	var url6="asuransi/asuransi03.php?p=3";
</script>
<div class="ui-widget-content" align="center">
	<input type="hidden" id="cetakpdf" name="cetakpdf"/>
	<input type="hidden" id="cetakxls" name="cetakxls"/>	
	<?php include 'form_harian02.php';?>
