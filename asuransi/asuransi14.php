...
<tbody>
	<?php
	$no=1;$vbayar='';
	$sawal=0;$sakhir=0;$org=0;$jumlah1=0;
	$tsawal=0;$tsakhir=0;$torg=0;$jumlah2=0;
	while ($row=$result->row($hasil)){
		if ($vbayar<>$row['produk']){
			...
			?>
			<tr><td colspan="9"><strong><?php echo $row['nmproduk']; ?></strong></td></tr>
			<?php
			$sawal=0;$sakhir=0;$org=0;$no=1;$jumlah1=0;
		}		
		?>
		<tr>
		<td><?php echo $no; ?></td>
