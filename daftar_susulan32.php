...
if($kkbayar!=9){
	$hasil=$result->query_lap("SELECT a.id,a.norek,a.nama,b.nocitra,b.nopen,a.pokok,a.bunga,a.adm,a.angsurke,a.jumlah,a.kdtran,b.kkbayar FROM $tabelSusulan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE b.kkbayar='$kkbayar' AND a.branch='$kcabang' AND a.kdtran=777 ORDER BY kdtran,nama,nocitra,norek");
}else{
	$hasil=$result->query_lap("SELECT a.id,a.norek,a.nama,b.nocitra,b.nopen,a.pokok,a.bunga,a.adm,a.angsurke,a.jumlah,a.kdtran,b.kkbayar FROM $tabelSusulan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE a.branch='$kcabang' AND a.kdtran=777 ORDER BY a.nama,b.nocitra,a.norek");	
}
