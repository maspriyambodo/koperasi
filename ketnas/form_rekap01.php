...
while ($row=$result->row($hasil)){ 
	...
	<tr>
		...
		<td align="right"><?php echo number_format($row['orang1']); ?></td>
		<?php 
			if($jumlah>0){
				$jum=($row['saldoa1']/$jumlah)*100;	
			}else{
				$jum=100;
			}
		?>
		...
		<td align="right"><?php echo number_format($row['orang2']); ?></td>
		<?php 
			if($jumlah>0){
				$jum=($row['saldoa2']/$jumlah)*100;
			}else{
				$jum=100;
			}
		?>
		...
		<td align="right"><?php echo number_format($row['orang3']); ?></td>
		<?php 
			if($jumlah>0){
				$jum=($row['saldoa3']/$jumlah)*100;
			}else{
				$jum=100;
			}		
		?>
		...
		<td align="right"><?php echo number_format($row['orang4']); ?></td>
		<?php 
			if($jumlah>0){
				$jum=($row['saldoa4']/$jumlah)*100;
			}else{
				$jum=100;
			}		
		?>
		...
		<td align="right"><?php echo number_format($row['orang5']); ?></td>
		<?php
			if($jumlah>0){
				$jum=($row['saldoa5']/$jumlah)*100;
			}else{
				$jum=100;
			}		
		?>
