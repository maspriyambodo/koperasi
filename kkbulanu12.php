...
if(isset($_POST['id'])){
	...
	for($i=0;$i<$idCount;$i++) {
		$result->query_y1("UPDATE $tabelTagihan SET kdtran=111,alasan_tt=0,solusi_tt=NULL,bussdate=now() WHERE Id='". $_POST["id"][$i]."'");
	...
	echo 'Sukses';
	$result->close();
	$catat="Koreksi Kwitansi Kembali ".$tabelTagihan;
	include 'around.php';
}else{
