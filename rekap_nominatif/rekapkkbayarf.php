...
<tbody>
	...
	while ($row = $result->row($hasil)) {
		...
		if ($vbayar<>$row['produk']){
			...
			<tr><td>&nbsp;</td><td colspan="9"><strong>KANTOR BAYAR : <?php echo $row['nmbayar'];?></strong></td></tr><?php
			$jsaldo_awal=0;$jkas_debet=0;$jkas_kredit=0;$jmemo_debet=0;$jmemo_kredit=0;$jsaldo_akhir=0;$jorg=0;
			$gsaldo_awal=0;$gkas_debet=0;$gkas_kredit=0;$gmemo_debet=0;$gmemo_kredit=0;$gsaldo_akhir=0;$gorg=0;
		}else{
			if($bayarx<>$row['kkbayar']){ 
				if($jsaldo_awal==0){
					$jml_saldoa1=100;
					$jml_saldoa2=100;
				}else{
				...
				<tr>
				<td>&nbsp;</td>
				<td colspan="9"><strong>KANTOR BAYAR : <?php echo $row['nmbayar'];?></strong></td>
				</tr>
				<?php
				$jsaldo_awal=0;$jkas_debet=0;$jkas_kredit=0;$jmemo_debet=0;$jmemo_kredit=0;$jsaldo_akhir=0;$jorg=0;
			}
