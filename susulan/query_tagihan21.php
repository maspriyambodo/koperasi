<?php $branch =$result->c_d($_GET['branch']);$kkbayar = $result->c_d($_GET['kkbayar']);$bln=$result->c_d($_GET['bln']);$thn=$result->c_d($_GET['thn']);$bulan=$bln.$thn;$tabel = $tabel_tagihan.$bln.substr($thn,2,2).'s';
if($ada==TRUE){
	if($branch=='0111'){
		if($kkbayar=='9'){
