		...
		if ($vbayar!=$row['produk']){ 
			if($no>1){
				...
				<tr class="td" bgcolor="#e5e5e5">
					...
					<td align="right"><?php echo number_format($jml_saldoa1,2);?></td>
					<td align="right"><?php echo number_format($gpokok2);?></td>
					<td align="right"><?php echo number_format($gbunga2);?></td>
					<td align="right"><?php echo number_format($gadm2);?></td>
					<td align="right"><?php echo number_format($gjumlah2);?></td>
					<td align="right"><?php echo number_format($gorg2);?></td>
					<td align="right"><?php echo number_format($jml_saldoa2,2);?></td>
					<td align="right"><?php echo number_format($gpokok3);?></td>
					<td align="right"><?php echo number_format($gbunga3);?></td>
					<td align="right"><?php echo number_format($gadm3);?></td>
					<td align="right"><?php echo number_format($gjumlah3);?></td>
					<td align="right"><?php echo number_format($gorg3);?></td>
					<td align="right"><?php echo number_format($jml_saldoa3,2);?></td>
				</tr><?php
			}
