...
$mpdf=new mPDF('c','A4','','',15,10,10,10,10,10); 
ob_start();?>
<table style="font-family: sans-serif;font-size: 8pt;"> <?php  
$kolom=2;$i=0;$no=1;
while($row=$result->row($hasil)){
	...
	<table width="100%" cellspacing="0" style="text-align: left; font-size: 9pt;">
		...
		<tr><td >Kantor Bayar</td><td >: <?php echo $row["nmbayar"];?></td></tr>
		<tr><td >Angsuran Ke</td><td >: <?php echo $row["angsurke"]." Dari ".$row["jangka"];?></td></tr>
		<tr><td >Jumlah</td><td >: <?php echo formatRupiah($total);?></td></tr>
		<tr><td colspan="2" style="font-size:8px">Terbilang : <?php echo " ".terbilang($total).' rupiah';?></td></tr>
