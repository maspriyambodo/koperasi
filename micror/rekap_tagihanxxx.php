...
<tbody><?php
	...
	while ($row = $result->fetch_array(MYSQLI_BOTH)) {
		if ($vbayar!=$row['produk']){ 
			...
			<tr><td colspan="14"><strong><?php echo $row['nmproduk']; ?></strong></td></tr><?php
		}
		if($no>1){
		...
		<tr>
			...
			<td align="right"><?php echo number_format($row['pokok1']+$row['pokok2']);?></td>
			<td align="right"><?php echo number_format($row['bunga1']+$row['bunga2']);?></td>
			<td align="right"><?php echo number_format($row['adm1']+$row['adm2']);?></td>
			<td align="right"><?php echo number_format($row['jumlah1']+$row['jumlah2']);?></td>
			<td align="right"><?php echo number_format($row['rek1']+$row['rek2']);?></td>
			<td>
			<?php 
				if($row['mutasi']=='K'){
					$kete='Mutasi Kas';
		...
		$jpokok1=$jpokok1+$row['pokok1']+$row['pokok2'];
		$jbunga1=$jbunga1+$row['bunga1']+$row['bunga2'];
		$jadm1=$jadm1+$row['adm1']+$row['adm2'];
		$jjumlah1=$jjumlah1+$row['jumlah1']+$row['jumlah2'];
		$jorg1=$jorg1+$row['rek1']+$row['rek2'];
		...
		$gpokok1=$gpokok1+$row['pokok1']+$row['pokok2'];
		$gbunga1=$gbunga1+$row['bunga1']+$row['bunga2'];
		$gadm1=$gadm1+$row['adm1']+$row['adm2'];
		$gjumlah1=$gjumlah1+$row['jumlah1']+$row['jumlah2'];
		$gorg1=$gorg1+$row['rek1']+$row['rek2'];
		...
		$tpokok1=$tpokok1+$row['pokok1']+$row['pokok2'];
		$tbunga1=$tbunga1+$row['bunga1']+$row['bunga2'];
		$tadm1=$tadm1+$row['adm1']+$row['adm2'];
		$tjumlah1=$tjumlah1+$row['jumlah1']+$row['jumlah2'];
		$torg1=$torg1+$row['rek1']+$row['rek2'];
