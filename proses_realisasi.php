...
<script type="text/javascript">
	var url1='proses_realisasii.php';
	$("select#kkbayar").focus();
</script>
<?php $result->query_x1("CREATE TEMPORARY TABLE $userid SELECT b.kkbayar,b.nmbayar FROM $tabelTagihan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE a.kdtran=111 GROUP BY b.kkbayar ORDER BY b.kkbayar");?>
<div class="ui-widget-content" align="center">
	<form id="formsearch" name="formsearch" method="post" action="">
		...
		<button id="proses_data">Proses Realisasi Tagihana Reguler</button>
	</form>
</div>
