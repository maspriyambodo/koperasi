<?php $bln=$result->c_d($_GET['bln']);$thn=$result->c_d($_GET['thn']);$bulan=$bln.substr($thn,2,2);;$branch=$result->c_d($_GET['branch']);$produk = $result->c_d($_GET['kdsales']);$pilih=$result->c_d($_GET['p']);$tabel=$tabel_transaksi.$bulan;$tabelm=$userid.'1';$tabelr=$tabel_tagihan.$bln.substr($thn,2,2).'b';$tabelx=$tabel_tagihan.$bln.substr($thn,2,2).'m';
if($branch=='0111'){
