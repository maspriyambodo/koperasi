...
$desc="LAPORAN RINCIAN MUTASI RRP HARIAN TANGGAL : ".$t;
include 'neracarra000.php';
$hasil = $result->query_x1("SELECT a.branch,a.nonas,a.nama,a.norekgssl,a.produk,a.$fieldhari1,a.$fieldhari2,a.$fieldhari3,a.$fieldhari4,a.$fieldhari5,a.$fieldhari6 FROM $userid a JOIN akuntansi.aknrrp b ON a.nonas=b.sandi where $fieldhari1!=0 or $fieldhari2!=0 or $fieldhari3!=0 or $fieldhari4!=0 or $fieldhari5!=0 or $fieldhari6!=0 ORDER BY nonas");
switch ($pilih){
