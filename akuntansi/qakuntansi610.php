	...
	if($bln=='01'){
		...
		if($thn!=$thnxxx){
			if($bln=='01'){
				...
				$tabeln='akuntansi.sandi'.$thn;
				$result->res("CREATE TEMPORARY TABLE $userid SELECT branch,nonas,nama,norekgssl,produk,$fieldhari1,$fieldhari2,$fieldhari3,$fieldhari4,$fieldhari5,$fieldhari6 FROM $tabeln WHERE branch='$branch' ORDER BY norekgssl");
