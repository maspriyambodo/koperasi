...
if($branch=='0111'){
	...
	$hasil=$result->query_x1("SELECT a.uraian,a.sandi,$fieldhari1,$fieldhari2,$fieldhari3,$fieldhari4,$fieldhari5,$fieldhari6,$fieldhari7,$fieldhari8,$fieldhari9,$fieldhari10,$fieldhari11,$fieldhari12 FROM $tabel a JOIN $tabel_sandi b ON a.sandi=b.nonas ORDER BY b.nonas");
}
?>