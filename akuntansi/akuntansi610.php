<?php 
include 'qakuntansi610.php';
$desc="POSISI SALDO BULAN : ".strtoupper(nmbulan($bln)).' '.$thn;
switch ($pilih){
...
case "1":
	...
	echo '<th colspan="2">SALDO AWAL '.strtoupper(nmbulan($blnl)).' '.$thnl.'</th>';
	echo '<th colspan="2">MUTASI KAS</th>';
	echo '<th colspan="2">MUTASI MEMORIAL</th>';
	echo '<th colspan="2">SALDO AKHIR '.strtoupper(nmbulan($bln)).' '.$thn.'</th>';
	echo '</tr>';
	echo '<tr class="td" bgcolor="#e5e5e5">';
	echo '<th>DEBET</th>';
	echo '<th>KREDIT</th>';
