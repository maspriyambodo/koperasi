...
<tbody><?php
	$no=1;
	$hasil=$result->query_x1("SELECT uraian,sandi,kd03,kd02,$naika,$naikz,$naiky,$naikx FROM $namafile");
	while ($row=$result->row($hasil)) { 
		if($row['sandi']=='A') { ?>
			<tr class="td" bgcolor="#e5e5e5">
				...
				<td align="right"><?php echo formatrp($row[$naika]);?></td>
