...
<td>
	<table width="100%">
		<tr><td height="30" align="center" width="50%"></td><td height="30" align="center" width="50%"></td></tr>
		<tr><td align="center" width="50%">'.$ncabang.', '.$tanggal.'</td><td height="30" align="center" width="50%"></td></tr>
		<tr><td align="center" width="50%">Mengetahui,</td><td height="30" align="center" width="50%">Ahli Waris</td></tr>
		
		<tr><td height="70" align="center" valign="bottom"></td><td height="70" align="center" valign="bottom">'.$row['nama_ahli_waris'].'</td></tr>	
		<tr><td align="center" valign="bottom">______________________________________</td><td align="center" valign="bottom">______________________________________</td></tr>

		<tr><td height="110"></td><td height="110"></td></tr>
	</table>
</td>
</tr>
</table>';
...
ob_end_clean();
$mpdf->SetFooter('Tanggal Cetak : {DATE j-m-Y}| |User Klaim : '.$row['user_klaim']);
