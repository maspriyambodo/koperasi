$(document).ready(function(){
	...
	$( "#btnrelaas" ).button().on( "click", function() {
		variabel();
		var cetak=$('#cetakxls').val();
		var url=cetak+'&'+dataString;
		newwindow=window.open(url);
	...
	function variabel(){
		tgl1=$("#tgl1").val();tgl2=$("#tgl2").val();bln=$("#bln").val();thn=$("#thn").val();branch=$("#branch").val();
		kdsales=$("#kdsales").val();	kkbayar =$("#kkbayar").val();flag=$("#flag").val();kdbyr=$("#kdbyr").val();
		kdkop=$("#kdkop").val();produk=$("#produk").val();
