...
if($kkbayar!=9){
	$hasil=$result->query_lap("SELECT SUM(a.pokok) AS pokok,SUM(a.bunga) AS bunga,SUM(a.adm) AS adm,SUM(a.jumlah) AS jumlah,COUNT(*) AS rekening,b.nmbayar,a.kdtran,b.kkbayar FROM $tabelTagihan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE b.kkbayar='$kkbayar' AND a.branch='$kcabang' GROUP BY a.kdtran,b.kkbayar ORDER BY b.kkbayar");
}else{
	$hasil=$result->query_lap("SELECT SUM(a.pokok) AS pokok,SUM(a.bunga) AS bunga,SUM(a.adm) AS adm,SUM(a.jumlah) AS jumlah,COUNT(*) AS rekening,b.nmbayar,a.kdtran,b.kkbayar FROM $tabelTagihan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE a.branch='$kcabang' GROUP BY a.kdtran,b.kkbayar ORDER BY b.kkbayar");
}
echo '
