...
<script type="text/javascript">var url1="rencana_reguleryy.php";</script>
<?php $bln++;if($bln>12){	$bln=1; $thn++;	$bln=substr("00"."".$bln,-2);}else{$bln=substr("00"."".$bln,-2);} ?>
...
<form id="formsearch" name="formsearch" method="post" action="">
	...
	<button type="button" id="proses_data">Proser Rencana Tagihan Reguler</button>
</form>
</div>
