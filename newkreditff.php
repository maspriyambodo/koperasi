...
<tr><th colspan="6" class="ui-state-highlight">DATA DEBITUR || JAMINAN DEBITUR</th></tr>
...
<tr>
	...
	<td>
	<input name="nopen" type="text" id="nopen" value="<?php echo $nopen; ?>" size="30" maxlength="15"  onkeyup="caps(this)"/>
	<button id="cek_nopen">Cek Nopen</button>
	</td>
</tr>
<tr>
...
<tr><th colspan="6" class="ui-state-highlight">DATA PENDAMPING DEBITUR</th></tr>
<tr>
	<td align="right">Nama :</td>
...
<tr><th colspan="6" class="ui-state-highlight">DATA FINANSIAL DEBITUR</th></tr>
<tr>
	<?php
	if($kdkop==1){ 
		echo '<td align="right">Pendapatan Per Bulan : </td>';
	}elseif($kdkop==2){
		echo '<td align="right">Pendapatan Per Hari : </td>';
	}else{
		echo '<td align="right">Pendapatan Per Minggu : </td>';
	}?>
...
<tr>
	<td align="right">Jumlah Pendapatan Kotor : </td>
	...
	<td align="right">Jumlah Pendapatan Bersih :</td>
...
<tr><th colspan="6" class="ui-state-highlight">DATA PINJAMAN BARU - <a style="cursor: pointer;" href="" onclick="showPayment('<?php echo $id;?>');return false;">PAYMENT SCEDULE</a></th></tr>
<tr>
...
<tr>
	...
	<td>
		...
		<option value="">PILIHAN</option>
		<?php 
		$huruf = array("KONSUMTIF","MODAL KERJA","INVESTASI");$i = 0;
		while($i < 3){
			if($deb1 == $huruf[$i]){
...
<tr>
	...
	<td>
		...
		<option value="">PILIHAN</option>
		<?php 
		$huruf = array("GIRO BTPN","TUNAI/TRANSFER","TABUNGAN TASETO");$i = 0;
		while($i < 3){
			if($kode_cair== $i){
...
<table width="100%">
<tr>
	<td>Saldo Pelunasan</td><td>: 
	<input style="text-align:right" readonly name="saldoa" type="text" id="saldoa" value="<?php echo $saldoa; ?>"/>
	<input readonly size="3" name="tgbatas" type="text" id="tgbatas" value="<?php echo $tgbatas; ?>"/></td>
