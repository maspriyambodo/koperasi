...
<script type="text/javascript">
	var url1='daftar_susulan31.php';
	$("select#kkbayar").focus();
</script>
<?php $result->query_x1("CREATE TEMPORARY TABLE $userid SELECT b.kkbayar,b.nmbayar FROM $tabelSusulan a JOIN $tabel_kredit b ON a.norek=b.norek WHERE a.kdtran=111 AND a.branch='$kcabang' GROUP BY b.kkbayar ORDER BY b.kkbayar");?>
