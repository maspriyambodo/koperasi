...
<tbody>
	<tr><td colspan="7"><strong><?php echo "RENCANA TAGIHAN";?></strong></td></tr>
	<?php
	$no=1;$vbayar='';$vlunas='';
	...
	while ($row = $result->fetch_array(MYSQLI_BOTH)) {
		...
		if ($vlunas!=$row['urut']){ 
			if($no>1){?>
				...
				if($row['urut']==2){ ?>
					<tr><td colspan="7"><strong><?php echo "REALISASI TAGIHAN";?></strong></td></tr><?php
				}elseif($row['urut']==3){ ?>
					<tr><td colspan="7"><strong><?php echo "SETORAN TAGIHAN";?></strong></td></tr><?php
				}elseif($row['urut']==4){ ?>
					<tr><td colspan="7"><strong><?php echo "TIDAK TERTAGIH";?></strong></td></tr><?php
				}
			}
			$jpokok1=0;$jbunga1=0;$jadm1=0;$jjumlah1=0;$jorg1=0;$no=1;
		}?>
		<tr>
			<td ><?php echo $no; ?></td>
			<td align="left"><?php echo $row['nmproduk']; ?></td>
