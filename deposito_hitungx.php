...
if($metode_hitung==0){
	...
	for($i=1;$i<=$jangka_waktu;$i++){
		...
		$bulan=$bln.$thn;
		$result->query_x1("INSERT INTO $tabelb(tanggal,bunga_bulanan,pajak_bulanan,bunga_bersih,jumlah_hari,bunga_ke,bulan_bunga,id_deposito)VALUES('$tgl_akhir','$bunga_bulan','$pajak_bulan','$net_bunga','$jumlah_hari','$i','$bulan','$ide')");
	}
}else{
