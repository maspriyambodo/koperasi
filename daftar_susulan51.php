...
<script type="text/javascript">
	$(document).ready(function () {
		$("#kwitansi").submit(function() {
			var r = confirm("Anda Yakin Koreksi Kwitansi Kembali Susulan..?");
			if (r == false) {
				return false;
			}
			$.ajax({
				type: "POST",
				url : "daftar_susulan52.php",
				data: $(this).serialize(),
				beforeSend: function () {
					$('#loading').show();
				},
	...
	function goKembali() {
		var url='daftar_susulan55.php';
		$('#innertub').load(url);
	}
</script>
<?php
$branch=$kcabang;$kkbayar=$result->c_d($_POST['kkbayar']);
if($kkbayar!=9){
	$hasil=$result->query_lap("SELECT a.id,a.branch,a.nonas,a.norek,a.nama,b.nodapem,b.nopen,a.pokok,a.bunga,a.adm,a.angsurke,a.jumlah,a.kdtran,a.alasan_tt,a.solusi_tt,b.jangka,b.nrekom,b.trekom,b.kkbayar,b.nmbayar,b.kdsales,c.alamat FROM $tabelSusulan a JOIN $tabel_kredit b ON a.norek=b.norek JOIN $tabel_nasabah c ON a.nonas=c.nonas WHERE b.kkbayar LIKE '$kkbayar' AND a.branch='$branch' AND a.kdtran=333 ORDER BY a.nama,b.kkbayar,a.norek");
}else{
	$hasil=$result->query_lap("SELECT a.id,a.branch,a.nonas,a.norek,a.nama,b.nodapem,b.nopen,a.pokok,a.bunga,a.adm,a.angsurke,a.jumlah,a.kdtran,a.alasan_tt,a.solusi_tt,b.jangka,b.nrekom,b.trekom,b.kkbayar,b.nmbayar,b.kdsales,c.alamat FROM $tabelSusulan a JOIN $tabel_kredit b ON a.norek=b.norek JOIN $tabel_nasabah c ON a.nonas=c.nonas WHERE a.branch='$branch' AND a.kdtran=333 ORDER BY a.nama,b.kkbayar,a.norek");
}
$no=1;?>
<form name="kwitansi" id="kwitansi" method="post" action="">
<table class="table" width="100%">
	<thead>
	<tr><th colspan="12"><?php echo 'DAFTAR KWITANSI KEMBALI SUSULAN BULAN : '.nmbulan($bln).' '.$thn;?></th></tr>
