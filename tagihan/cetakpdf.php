...
while($row = $result->row($hasil)){
	...
	<table width="100%" cellspacing="0" style="text-align: left; font-size: 9pt;">
		...
		<tr>
			...
			<td width="85%" align="center">BUKTI PEMBAYARAN ANGSURAN PINJAMAN<br/>Jl. Taman Galaxy Raya No.5B<br/>Jaka Setia, Bekasi Selatan<br/>021-82738377 | 087786130256</td>
		</tr>			
		...
		<tr><td >Petugas Koperasi</td><td >: <?php echo $row["namas"];?></td></tr>
