...
<tbody><?php
	...
	while ($row = $result->row($hasil)) {
		...
		<tr>
			...
			<td align="left"><?php echo $row['nama_inventaris']; ?></td>
			<td align="right"><?php echo number_format($row['jumlah_unit']);?></td>
		...
		$jumlah1=$jumlah1+$row['jumlah_unit'];
